...
<div id="app" class="flex max-w-6xl mx-auto px-6 py-8 gap-10 min-h-[700px]">
  ...
  <div class="w-56 bg-white shadow-md p-4 rounded">
    <ul class="space-y-2 font-semibold">
      <li><a :class="{ 'bg-blue-950 text-white': currentPage === 'guide-schedule.do' }" href="/mypage/guide-schedule.do" class="block px-3 py-2 rounded hover:bg-blue-950">나의 스케줄</a></li>
