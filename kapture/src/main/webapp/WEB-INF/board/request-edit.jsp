...
<body class="bg-white text-gray-800 font-sans text-[16px] tracking-wide">
	...
	<div id="app" class="max-w-5xl mx-auto py-10">
			...
			<tr>
				...
				<td colspan="2" class="px-4 py-3 border">
					<div class="flex items-center space-x-3">
						...
						<input :value="budget" @input="onBudgetInput" placeholder="금액 입력"
		...
		<div class="mt-6 text-right">
			...
			<button class="ml-4 px-6 py-3 bg-gray-300 text-gray-800 font-semibold rounded hover:bg-gray-400 transition"
				@click="fnBack">
				취소
			</button>
		</div>
