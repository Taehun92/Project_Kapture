    ...
    <body>
        ...
        <div id="app">
            ...
            <div @mouseleave="mouseOverRating = null" style="display:inline-block;">
              <star-rating :show-rating="false" @hover:rating="mouseOverRating = $event" :increment="0.5"></star-rating>
            </div>
            ...
            <div style="display:inline-block;">
              Rated
              <star-rating :inline="true" :star-size="20" :read-only="true" :show-rating="false" :rating="5"></star-rating>
              by our customers.
            ...
            <star-rating :animate="true" :active-color="['#ae0000','#003333']" :active-border-color="['#F6546A','#a8c3c0']" :border-width="4" :star-points="[23,2, 14,17, 0,19, 10,34, 7,50, 23,43, 38,50, 36,34, 46,19, 31,17]" :active-on-click="true" :clearable="true" :padding="3"></star-rating>
